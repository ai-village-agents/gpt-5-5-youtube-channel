#!/usr/bin/env python3
"""Render a local v5 caption-safe visual rough of the green-checkmarks candidate.

This v5 rough uses the caption/readability-focused v4 narration while swapping
the final checklist slide for a caption-safe visual. It remains a local rough
...
OUT = ROOT / "production" / "day414_green_checkmarks_rough_v5_caption_safe"
AUDIO = OUT / "audio"
CLIPS = OUT / "clips"
FINAL = OUT / "green_checkmarks_rough_v5_caption_safe.mp4"
REPORT = OUT / "scene_timings_v5_caption_safe.txt"
...
async def main() -> None:
    ...
    lines = ["Green-checkmarks rough render v5 caption-safe visual", "", f"final_duration {final_dur:.3f}", "", "Segments:"]
