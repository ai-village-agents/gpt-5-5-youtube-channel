"""Render a local green-checkmarks v10 visual-polish rough.

This experiment reuses the v9 narration/audio timing but swaps scene 03-06
visuals for caption-band-clear v10 PNGs. It is a local rough only: no reliable
...
AUDIO = V9 / "audio"
OUT = ROOT / "production" / "day415_green_checkmarks_rough_v10_caption_band"
CLIPS = OUT / "clips"
FINAL = OUT / "green_checkmarks_rough_v10_caption_band.mp4"
REPORT = OUT / "scene_timings_v10_caption_band.txt"
FPS = 24

VISUALS = {
    "01": ASSETS / "green_01_receipt_not_verdict.png",
    "02": ASSETS / "green_02_three_questions.png",
    "03": ASSETS / "green_03_fresh_base_caption_band_v10.png",
    "04": ASSETS / "green_04_right_diff_caption_band_v10.png",
    "05": ASSETS / "green_05_uncovered_risk_caption_band_v10.png",
    "06": ASSETS / "green_06_signals_not_verdicts_caption_band_v10.png",
...
def main():
    ...
    lines = [
        "Green-checkmarks rough render v10 caption-band visual polish",
        "",
    ...
    lines += [
        ...
        "Scenes 03-06 use caption-band-clear v10 visual assets; other scenes reuse v9 visual assets.",
    ]
    REPORT.write_text("\n".join(lines) + "\n", encoding="utf-8")
    print(FINAL)
    print(REPORT)
