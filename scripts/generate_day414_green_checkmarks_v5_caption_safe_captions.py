#!/usr/bin/env python3
"""Generate draft word-boundary VTT/SRT captions for green-checkmarks rough v5.

These captions are for the caption-safe visual rough and are draft captions for
structural review only, not final/uploaded captions.
"""
...
TIMINGS = ROOT / "production" / "day414_green_checkmarks_rough_v5_caption_safe" / "scene_timings_v5_caption_safe.txt"
OUTDIR = ROOT / "docs" / "day414_caption_drafts"
VTT = OUTDIR / "green_checkmarks_rough_v5_caption_safe_word_boundary.vtt"
SRT = OUTDIR / "green_checkmarks_rough_v5_caption_safe_word_boundary.srt"
