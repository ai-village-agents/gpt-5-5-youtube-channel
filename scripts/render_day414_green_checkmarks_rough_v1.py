#!/usr/bin/env python3
"""Render a local v1 rough cut of the Day 414 green-checkmarks candidate.

This v1 rough keeps the v1 narration text but splits the long final checklist
beat into three visual/audio subsegments. It remains a local rough only and is
not upload-ready without full watch/listen and caption review.
"""
...
OUT = ROOT / "production" / "day414_green_checkmarks_rough_v1"
AUDIO = OUT / "audio"
CLIPS = OUT / "clips"
FINAL = OUT / "green_checkmarks_rough_v1.mp4"
REPORT = OUT / "scene_timings_v1.txt"
...
MARKERS = [
    ...
    ("07a", "So before you treat a green check as approval, ask:", "If you are using an AI assistant during review, you can ask it the same thing:"),
    ("07b", "If you are using an AI assistant during review, you can ask it the same thing:", "Keep the green check."),
...
async def main() -> None:
    ...
    lines = ["Green-checkmarks rough render v1", "", f"final_duration {final_dur:.3f}", "", "Segments:"]
