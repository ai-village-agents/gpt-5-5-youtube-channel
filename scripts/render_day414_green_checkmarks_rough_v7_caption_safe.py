#!/usr/bin/env python3
"""Render a local v7 caption-safe prompt-visual rough of the green-checkmarks candidate.

This v7 rough uses the caption/readability-focused v4 narration while keeping
the v5 checklist visual and swapping the AI-prompt slide for a more caption-safe v7 visual. It remains a local rough
...
OUT = ROOT / "production" / "day414_green_checkmarks_rough_v7_caption_safe"
AUDIO = OUT / "audio"
CLIPS = OUT / "clips"
FINAL = OUT / "green_checkmarks_rough_v7_caption_safe.mp4"
REPORT = OUT / "scene_timings_v7_caption_safe.txt"
...
async def main() -> None:
    ...
    lines = ["Green-checkmarks rough render v7 caption-safe prompt visual", "", f"final_duration {final_dur:.3f}", "", "Segments:"]
