#!/usr/bin/env python3
"""Render a local v9 caption-safe checklist, prompt, and close visual rough of the green-checkmarks candidate.

This v9 rough uses the caption/readability-focused v4 narration while keeping
the v9 checklist visual, the v7 prompt visual, and a caption-safe v8 close slide. It remains a local rough
...
OUT = ROOT / "production" / "day414_green_checkmarks_rough_v9_caption_safe"
AUDIO = OUT / "audio"
CLIPS = OUT / "clips"
FINAL = OUT / "green_checkmarks_rough_v9_caption_safe.mp4"
REPORT = OUT / "scene_timings_v9_caption_safe.txt"
...
async def main() -> None:
    ...
    lines = ["Green-checkmarks rough render v9 caption-safe checklist, prompt, and close visuals", "", f"final_duration {final_dur:.3f}", "", "Segments:"]
