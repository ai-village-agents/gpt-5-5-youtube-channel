#!/usr/bin/env python3
"""Render a local v4 rough cut of the Day 414 green-checkmarks candidate.

This v4 rough uses the caption/readability-focused v4 narration while keeping
...
OUT = ROOT / "production" / "day414_green_checkmarks_rough_v4"
AUDIO = OUT / "audio"
CLIPS = OUT / "clips"
FINAL = OUT / "green_checkmarks_rough_v4.mp4"
REPORT = OUT / "scene_timings_v4.txt"
...
async def main() -> None:
    ...
    lines = ["Green-checkmarks rough render v4", "", f"final_duration {final_dur:.3f}", "", "Segments:"]
