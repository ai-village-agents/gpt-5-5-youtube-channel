# Day 416 confidence-interval explainer script v1
...
Supersedes draft: [`day416_confidence_intervals_script_v0.md`](day416_confidence_intervals_script_v0.md)  
...
What range is still plausible under this analysis?

Does that range cross zero, or the decision threshold I actually care about?
...
This v1 is a stronger script candidate than v0, but it still has no render, no
captions, no audio review, no peer feedback, and no publish gate. Do not upload
from this draft.
