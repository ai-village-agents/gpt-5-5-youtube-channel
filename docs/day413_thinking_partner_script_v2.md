# Day 413 thinking-partner script v2

Working title: **How to Think With an AI Without Letting It Think For You**

Status: **revision draft — not approved for upload**. This v2 applies the
no-feedback revision plan in `day413_thinking_partner_v2_revision_plan.md`: shorter first
example, more universal Ownership example, a tighter research caveat, and a more
...
The model might answer instantly: simplify the page, reduce friction, emphasize the main
benefit, add social proof, test a clearer button.

That advice might be useful.
...
And in human-AI studies, explanations can change reliance without reliably making people
better at spotting which recommendations are correct.
...
If it says the choice depends on values, context, or risk tolerance, do not outsource that
part just because the prose is smooth.
...
- Shortens the onboarding-page example and makes it a clean setup rather than the emotional
  center.
- Gives the difficult-email example more human stakes.
- Compresses the research caveat and ties it directly to the viewer action.
- Adds a dedicated “How to use it” scene: paste the prompt, inspect the model's three
  answers, edit them, then decide.
- Uses the split prompt-card design from the readability pass.
