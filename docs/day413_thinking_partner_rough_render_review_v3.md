...
```json
{
  ...
  "format": {"duration": "419.545000", "size": "17806366"}
}
```
...
- Captions are obsolete: the v4 word-boundary captions do not match this v5/v3 render and must be
  regenerated before any upload.
- Scene 06 and Scene 07 reuse prompt-proof frames from the v4 era. They appear compatible with the
  v5 wording in the contact sheet, but they still need full watch/readability review.
...
3. regenerated v5/v3 word-boundary captions plus manual caption review;
